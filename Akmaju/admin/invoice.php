                                ...
                                <td>
                                    ...
                                    <div class="dropdown mb-4">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a class="dropdown-item" href="invoice-detail.php?quotation_id=<?= $quotation['quotation_id'] ?>">View Invoice Detail</a>
                                            <?php if ($quotation['invoice_status'] == '1') : ?>
                                                <a class="dropdown-item" href="invoice-edit.php?quotation_id=<?= $quotation['quotation_id'] ?>">Edit Invoice</a>
                                                 <a class="dropdown-item" href="do-details.php?quotation_id=<?= $quotation['quotation_id'] ?>">View DO</a>
                                                <button type="button" class="dropdown-item" onclick="invoiceDelete(<?= $quotation['quotation_id'] ?>)">Delete Invoice</button>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
