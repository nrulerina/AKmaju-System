...
if (isset($_GET['product_id'])) {
    ...
    if ($result_product->num_rows > 0) {
        ...
        $sql_quotation_detail = "SELECT * FROM quotation_details JOIN quotations ON quotations.quotation_id=quotation_details.quotation_detail_quotation_id WHERE quotations.quotation_status=1 AND quotation_detail_product_id = '$product_id'";
