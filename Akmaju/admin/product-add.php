...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($error)) {
        $sql_product = "INSERT INTO `products`(`product_category_id`, `product_name`, `product_description`, `product_cost_price`, `product_selling_price`, `product_tax_code`, `product_tax_amount`, `product_discount_percent`, `product_discount_amount`, `product_quantity`,`product_updated_quantity`, `product_status`) VALUES ('$product_category_id','$product_name','$product_description','$product_cost_price','$product_selling_price','$product_tax_code','$product_tax_amount','$product_discount_percent','$product_discount_amount','$product_quantity','$product_quantity','$product_status')";
