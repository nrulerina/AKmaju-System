                                ...
                                <div class="dropdown mb-4">
                                    <div class= "text-center">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <a href="viewpdf.php?quotation_id=<?= $quotation['quotation_id'] ?>"  style="text-decoration: none;">View Payment Proof</a>
                                            <br>
                                    <a href="javascript:void(0);" onclick="confirmReset(<?= $quotation['quotation_id'] ?>)"  style="text-decoration: none;"> Change Payment Proof
                                    </a>
                                        </div>
                                </td>
